...
class YourTestCase(TestCase):
    def setUp(self):
        self.client = Client()
        self.user_viewer = User.objects.create_user(username="john", email="viewer@example.com", password="johnpass", role="viewer")
        self.user_annotator = User.objects.create_user(username="marie", email="annotator@example.com", password="mariepass", role="annotator")
        self.user_reviewer = User.objects.create_user(username="alice", email="reviewer@example.com", password="alicepass", role="reviewer")
