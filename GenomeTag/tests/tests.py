...
class YourTestCase(TestCase):
    def setUp(self):
        ...
        self.user_viewer = User.objects.create_user(
            username="john", email="viewer@example.com", password=make_password(None), role="viewer"
        )
    ...
    def test_create_annotation_annotator(self):
        ...
        create_annotation_url = reverse(
            "GenomeTag:create"
        )  # Replace 'create_annotation' with the actual name or URL pattern name of your view
