search_dic = {
        ...
        "Annotation": ["Access Number", "Start Position","Start Relative Position", "End Position","End Relative Position","Length","Sequence", "strand", "Chromosome access number", "Genome access number", "Author id", "Tag id", "Element in text", "Status (u,r,v or combinaition)"]
}
